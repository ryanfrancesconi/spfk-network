# SPFKNetwork
[![CI](https://img.shields.io/github/actions/workflow/status/ryanfrancesconi/spfk-network/ci.yml?branch=development)](https://github.com/ryanfrancesconi/spfk-network/actions/workflows/ci.yml)
